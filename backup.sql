...
--
-- TOC entry 484 (class 1247 OID 16395)
-- Name: continenttype; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE continenttype AS ENUM (
    'Asia',
    'Europe',
    'North America',
    'Africa',
...
--
-- TOC entry 487 (class 1247 OID 16410)
-- Name: isofficialtype; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE isofficialtype AS ENUM (
    'T',
    'F'
);
